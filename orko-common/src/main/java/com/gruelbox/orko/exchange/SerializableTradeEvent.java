...
/**
 * This can be removed once the websocket data format has been rationalised using custom serialisers.
 */
@AutoValue
@JsonDeserialize
public abstract class SerializableTradeEvent {
  ...
  @JsonCreator
  public static SerializableTradeEvent create(@JsonProperty("spec") TickerSpec spec,
                                              @JsonProperty("trade") SerializableTrade trade) {
