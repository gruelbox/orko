 ...
 */
public class GuavaRateController implements RateController {

  private static final Logger LOGGER = LoggerFactory.getLogger(GuavaRateController.class);
   ...
   */
  GuavaRateController(String exchangeName, RateLimiter rateLimiter, Duration throttleBy) {
  ...
  @Override
  public boolean canThrottleFurther() {
