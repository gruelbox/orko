...
public class CreateJ00qClasses {
  ...
  public static void main(String[] args) throws Exception {
    ...
    orkoConfiguration.setDatabase(new DbConfiguration());
    Guice.createInjector(new DbModule()).getInstance(CreateJ00qClasses.class).run();
  }
...
//    configuration.getGenerator().getTarget().setPackageName("com.grahamcrockford.orko.db.generated");
