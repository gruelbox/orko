...
public final class Fork {
  ...
  public static Process exec(Class<?> clazz, String... args) throws IOException, InterruptedException {
    ...
    Process process = new ProcessBuilder(allArgs.toArray(new String[0]))
  ...
  public static Future<?> pipeOutput(Process process, OutputStream outputStream, ExecutorService executorService) {
    return executorService.submit(() -> {
