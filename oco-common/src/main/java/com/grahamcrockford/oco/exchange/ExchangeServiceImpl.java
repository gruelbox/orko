...
public class ExchangeServiceImpl implements ExchangeService {
  ...
  /**
   * @see com.grahamcrockford.oco.exchange.ExchangeService#getExchanges()
   */
  @Override
  ...
  /**
   * @see com.grahamcrockford.oco.exchange.ExchangeService#get(java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.grahamcrockford.oco.exchange.ExchangeService#fetchTicker(com.grahamcrockford.oco.spi.TickerSpec)
   */
  @Override
  ...
  /**
   * @see com.grahamcrockford.oco.exchange.ExchangeService#fetchCurrencyPairMetaData(com.grahamcrockford.oco.spi.TickerSpec)
   */
  @Override
