...
class DbJobLocker implements JobLocker {
  ...
  /**
   * @see com.grahamcrockford.oco.submit.JobLocker#attemptLock(java.lang.String, java.util.UUID)
   */
  @Override
  ...
  /**
   * @see com.grahamcrockford.oco.submit.JobLocker#releaseLock(java.lang.String, java.util.UUID)
   */
  @Override
  ...
  /**
   * @see com.grahamcrockford.oco.submit.JobLocker#releaseAnyLock(java.lang.String)
   */
  @Override
  ...
  /**
   * @see com.grahamcrockford.oco.submit.JobLocker#releaseAllLocks()
   */
  @Override
  ...
  /**
   * @see com.grahamcrockford.oco.submit.JobLocker#updateLock(java.lang.String, java.util.UUID)
   */
  @Override
