...
public class TestJobExecutionIntegration {
  ...
  private final ExecutorServiceManager executorServiceManager = new ExecutorServiceManager();
  ...
  public void setup() throws Exception {
    ...
    jobSubmitter = new JobSubmitterImpl(jobAccess, jobLocker, injector, asyncEventBus);
